...
1. On the OAuth apps page, click **Go to app governance**.
   ...
   > **Note:** It may take 3–4 hours for the Microsoft Defender portal to enable OAuth apps in App Governance. Continue with the next step in the lab and check the status later. 
