...
> **⚠ Important Usage Guidance:** App Governance detection policies may take several minutes to trigger. If incidents or flagged apps do not appear immediately, wait and refresh the page before rechecking.
